'''This corresponds to the submit portion of the application. The status field (except 4th) in all the applications is set to submit and
   these fields can no longer be modified. Emails are automatically sent to the mentioned referees.
   If any previous fields are empty, these actions fail and an alert is rendered.  
'''
