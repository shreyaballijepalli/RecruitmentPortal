...
cur.execute('''CREATE TABLE teaching_experience (application_no integer references main_table(application_no),
	status text, position position_info,experience_organization text[],experience_start_date date[],
	experience_end_date date[], experience_total_period integer[], experience_full_time boolean[],
	experience_desgn text[],experience_type_of_work text[],
	project_type text[],project_number integer[],project_amount integer[],
	google_scholar text, dblp text, linkedin text,
	referee1 referee_info,referee2 referee_info,referee3 referee_info);''')
